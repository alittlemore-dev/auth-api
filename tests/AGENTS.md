...
- Real PostgreSQL test DB (`auth_api_database_test`) — tests under `tests/integration/`
...
named from the base database plus the xdist worker suffix, such as `auth_api_database_test_gw0`.
