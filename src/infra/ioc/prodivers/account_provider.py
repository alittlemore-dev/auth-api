...
from core.account.avatar_schemas import AvatarOrphanCleanupUseCaseConfig
...
class UserAccountProvider(Provider):
    ...
    @provide(scope=Scope.APP)
    async def provide_avatar_orphan_cleanup_use_case_config(
        self,
    ) -> AvatarOrphanCleanupUseCaseConfig:
        return AvatarOrphanCleanupUseCaseConfig(
